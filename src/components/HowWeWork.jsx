    ...
    return (
        ...
        <div className="relative z-10">
            ...
            <div className="relative">
                {/* Progress Line - Center for desktop */}
                ...
                {processSteps.map((step, index) => (
                    ...
                    >
                    {/* Content - Alternating sides on desktop, always below icon on mobile */}
                    ...
                    {/* Icon Circle - Center for desktop, top for mobile */}
                    <div className="md:w-2/12 flex justify-center relative order-1 md:order-none">
                        ...
                        {/* Connecting Line for Mobile - From icon to next icon */}
