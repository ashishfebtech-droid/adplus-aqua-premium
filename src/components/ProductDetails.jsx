            ...
            {bottleSizes.map((bottle, index) => (
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <h4 className="text-2xl font-semibold text-gray-800 mb-4">{bottle.title}</h4>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {specifications.map((spec, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">{spec.title}</h4>
                  <p className="text-2xl font-bold text-gray-900 mb-2">{spec.value}</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 shadow-sm max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                  <h4 className="text-gray-800 font-semibold mb-2">🎨 Full Color Printing</h4>
                  <p className="text-gray-600 text-sm">Your logo, message, and design in vibrant colors</p>
                </div>
                
                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                  <h4 className="text-gray-800 font-semibold mb-2">💦 Waterproof Labels</h4>
                  <p className="text-gray-600 text-sm">Durable labels that don't fade or peel</p>
                </div>
                
                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                  <h4 className="text-gray-800 font-semibold mb-2">📐 Custom Sizes</h4>
                  <p className="text-gray-600 text-sm">Special sizes available on request</p>
                </div>
              </div>
